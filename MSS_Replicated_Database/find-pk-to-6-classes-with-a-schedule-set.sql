...
SELECT 
	MSS_SCHEDULE.SCH_SCHEDULE_NAME,
	MSS_SCHEDULE.SCH_START_DATE,
	MSS_SCHEDULE.SCH_END_DATE,
  ...
  FROM 
	...
	LEFT JOIN MSS_SCHEDULE ON MSS_SCHEDULE_MASTER.MST_SCH_OID=MSS_SCHEDULE.SCH_OID

  WHERE
    MSS_SCHEDULE_MASTER.MST_SCHEDULE_DISPLAY IS NOT NULL
	AND MSS_COURSE_SCHOOL.CSK_GRADE_LEVEL NOT IN ('00', '07', '08', '09', '10', '11', '12')
	AND SCH_SCHEDULE_NAME = '2023-2024 Active Schedule'

  ORDER BY 
    MSS_SCHEDULE.SCH_START_DATE DESC,
	SKL_SCHOOL_NAME ASC,
